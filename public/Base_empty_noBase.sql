...
-- Started on 2025-05-30 15:06:46
...
--
-- TOC entry 296 (class 1255 OID 16386)
...
--
-- TOC entry 303 (class 1255 OID 16387)
...
--
-- TOC entry 306 (class 1255 OID 16388)
...
--
-- TOC entry 307 (class 1255 OID 16389)
...
--
-- TOC entry 308 (class 1255 OID 16390)
...
--
-- TOC entry 310 (class 1255 OID 16391)
...
--
-- TOC entry 311 (class 1255 OID 16392)
...
--
-- TOC entry 312 (class 1255 OID 16393)
...
--
-- TOC entry 313 (class 1255 OID 16394)
...
--
-- TOC entry 314 (class 1255 OID 16395)
...
--
-- TOC entry 315 (class 1255 OID 16396)
...
--
-- TOC entry 317 (class 1255 OID 16397)
...
--
-- TOC entry 318 (class 1255 OID 16398)
...
--
-- TOC entry 421 (class 1255 OID 16399)
...
--
-- TOC entry 319 (class 1255 OID 16401)
...
--
-- TOC entry 320 (class 1255 OID 16402)
...
--
-- TOC entry 322 (class 1255 OID 16403)
...
--
-- TOC entry 323 (class 1255 OID 16404)
...
--
-- TOC entry 324 (class 1255 OID 16405)
...
--
-- TOC entry 432 (class 1255 OID 25419)
-- Name: AddNewRelation(bigint, bigint, bigint, bigint, bigint); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."AddNewRelation"("FltDocumentId1" bigint, "FltDocumentId2" bigint, "FltAssignmentId1" bigint, "FltAssignmentId2" bigint, "FltUserId" bigint) RETURNS TABLE(id bigint, "documentId1" bigint, "documentId2" bigint, "assignmentId1" bigint, "assignmentId2" bigint, created_at timestamp without time zone, updated_at timestamp without time zone, removed timestamp without time zone, "userId" bigint)
    LANGUAGE plpgsql
    AS $$
 DECLARE 
 	"Id" bigint;
 BEGIN
 	INSERT INTO "relations" ("documentId1", 
						 "documentId2", 
						 "assignmentId1", 
						 "assignmentId2", 
						 "created_at",
						 "userId")
  			VALUES ("FltDocumentId1",
					"FltDocumentId2",
					"FltAssignmentId1",
					"FltAssignmentId2",
					current_timestamp,
					"FltUserId")
			RETURNING "relations"."id" INTO "Id";
			RETURN QUERY SELECT "id",
								...
								"removed",
								"userId"
						FROM "relations" WHERE "relations"."id" = "Id";
 END
 $$;


ALTER FUNCTION public."AddNewRelation"("FltDocumentId1" bigint, "FltDocumentId2" bigint, "FltAssignmentId1" bigint, "FltAssignmentId2" bigint, "FltUserId" bigint) OWNER TO postgres;

--
-- TOC entry 325 (class 1255 OID 16406)
...
--
-- TOC entry 326 (class 1255 OID 16407)
...
--
-- TOC entry 327 (class 1255 OID 16408)
...
--
-- TOC entry 328 (class 1255 OID 16409)
...
--
-- TOC entry 329 (class 1255 OID 16410)
...
--
-- TOC entry 330 (class 1255 OID 16411)
...
--
-- TOC entry 331 (class 1255 OID 16412)
...
--
-- TOC entry 332 (class 1255 OID 16413)
...
--
-- TOC entry 333 (class 1255 OID 16414)
...
--
-- TOC entry 334 (class 1255 OID 16415)
...
--
-- TOC entry 335 (class 1255 OID 16416)
...
--
-- TOC entry 336 (class 1255 OID 16417)
...
--
-- TOC entry 337 (class 1255 OID 16418)
...
CREATE FUNCTION public."GetAgreementAndUserInOrder"("FltUserId" bigint, "FltAgreementId" bigint) RETURNS TABLE(id bigint, "agreementId" bigint, "userId" bigint, note text, created_at timestamp without time zone, updated_at timestamp without time zone, removed timestamp without time zone, refused_at timestamp without time zone, approved_at timestamp without time zone, viewed_at timestamp without time zone, "order" smallint)
	...
	BEGIN 	
		FOR "arr" IN (
			SELECT * FROM "GetAgreementAndUserByAgreementId"("FltAgreementId") AS "ga" 
					WHERE "ga"."removed" IS NULL 
						AND "ga"."refused_at" IS NULL 
						AND "ga"."approved_at" IS NULL 
					ORDER BY "ga"."order" ASC LIMIT 1
		) LOOP
			BEGIN
				IF ("arr"."userId" = "FltUserId") THEN
					BEGIN
						RETURN QUERY SELECT "agreements_and_users"."id",
											...
											"agreements_and_users"."viewed_at",
											"agreements_and_users"."order"
						FROM "agreements_and_users" WHERE "agreements_and_users"."id" = "arr"."id";
					END;
				END IF;
			END;
		END LOOP;
...
--
-- TOC entry 338 (class 1255 OID 16419)
...
--
-- TOC entry 339 (class 1255 OID 16420)
...
--
-- TOC entry 340 (class 1255 OID 16421)
...
--
-- TOC entry 341 (class 1255 OID 16422)
...
--
-- TOC entry 342 (class 1255 OID 16423)
...
--
-- TOC entry 343 (class 1255 OID 16424)
...
--
-- TOC entry 409 (class 1255 OID 16425)
...
--
-- TOC entry 425 (class 1255 OID 25410)
...
--
-- TOC entry 345 (class 1255 OID 16427)
...
--
-- TOC entry 433 (class 1255 OID 25420)
-- Name: GetAllRelations(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."GetAllRelations"() RETURNS TABLE(id bigint, "documentId1" bigint, "documentId2" bigint, "assignmentId1" bigint, "assignmentId2" bigint, created_at timestamp without time zone, updated_at timestamp without time zone, removed timestamp without time zone, "userId" bigint)
    LANGUAGE plpgsql
    AS $$
	BEGIN 	
		RETURN QUERY SELECT "relations"."id", 
							"relations"."documentId1",
							"relations"."documentId2",
							"relations"."assignmentId1",
							"relations"."assignmentId2",
...
ALTER FUNCTION public."GetAllRelations"() OWNER TO postgres;

--
-- TOC entry 346 (class 1255 OID 16428)
...
--
-- TOC entry 347 (class 1255 OID 16429)
...
--
-- TOC entry 348 (class 1255 OID 16430)
...
--
-- TOC entry 349 (class 1255 OID 16431)
...
--
-- TOC entry 350 (class 1255 OID 16432)
...
--
-- TOC entry 351 (class 1255 OID 16433)
...
--
-- TOC entry 316 (class 1255 OID 16434)
...
--
-- TOC entry 321 (class 1255 OID 16435)
...
--
-- TOC entry 344 (class 1255 OID 16436)
...
--
-- TOC entry 352 (class 1255 OID 16437)
...
--
-- TOC entry 353 (class 1255 OID 16438)
...
--
-- TOC entry 354 (class 1255 OID 16439)
...
--
-- TOC entry 355 (class 1255 OID 16440)
...
--
-- TOC entry 356 (class 1255 OID 16441)
...
--
-- TOC entry 357 (class 1255 OID 16442)
...
--
-- TOC entry 358 (class 1255 OID 16443)
...
--
-- TOC entry 359 (class 1255 OID 16444)
...
--
-- TOC entry 360 (class 1255 OID 16445)
...
--
-- TOC entry 289 (class 1255 OID 16446)
...
--
-- TOC entry 291 (class 1255 OID 16447)
...
--
-- TOC entry 292 (class 1255 OID 16448)
...
--
-- TOC entry 309 (class 1255 OID 16449)
...
--
-- TOC entry 422 (class 1255 OID 16450)
...
--
-- TOC entry 430 (class 1255 OID 25414)
...
--
-- TOC entry 428 (class 1255 OID 25412)
...
--
-- TOC entry 363 (class 1255 OID 16455)
...
--
-- TOC entry 364 (class 1255 OID 16456)
...
--
-- TOC entry 365 (class 1255 OID 16457)
...
--
-- TOC entry 426 (class 1255 OID 25411)
...
--
-- TOC entry 366 (class 1255 OID 16459)
...
--
-- TOC entry 367 (class 1255 OID 16460)
...
--
-- TOC entry 431 (class 1255 OID 25415)
...
--
-- TOC entry 368 (class 1255 OID 16462)
...
--
-- TOC entry 370 (class 1255 OID 16463)
...
--
-- TOC entry 371 (class 1255 OID 16464)
...
--
-- TOC entry 372 (class 1255 OID 16465)
...
--
-- TOC entry 373 (class 1255 OID 16466)
...
--
-- TOC entry 374 (class 1255 OID 16467)
...
--
-- TOC entry 375 (class 1255 OID 16468)
...
--
-- TOC entry 378 (class 1255 OID 16472)
...
--
-- TOC entry 379 (class 1255 OID 16473)
...
--
-- TOC entry 380 (class 1255 OID 16474)
...
--
-- TOC entry 381 (class 1255 OID 16475)
...
--
-- TOC entry 434 (class 1255 OID 25421)
-- Name: GetRelationById(bigint); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."GetRelationById"("FltId" bigint) RETURNS TABLE(id bigint, "documentId1" bigint, "documentId2" bigint, "assignmentId1" bigint, "assignmentId2" bigint, created_at timestamp without time zone, updated_at timestamp without time zone, removed timestamp without time zone, "userId" bigint)
    LANGUAGE plpgsql
    AS $$
	BEGIN 	
		RETURN QUERY SELECT "relations"."id", 
							...
							"relations"."userId"
					FROM "relations" 
					WHERE "relations"."id" = "FltId" AND "relations"."removed" IS NULL;
	END;
	$$;


ALTER FUNCTION public."GetRelationById"("FltId" bigint) OWNER TO postgres;

--
-- TOC entry 436 (class 1255 OID 25423)
-- Name: GetRelationsByAssignmentId(bigint); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."GetRelationsByAssignmentId"("FltAssignmentId" bigint) RETURNS TABLE(id bigint, "documentId1" bigint, "documentId2" bigint, "assignmentId1" bigint, "assignmentId2" bigint, created_at timestamp without time zone, updated_at timestamp without time zone, removed timestamp without time zone, "userId" bigint)
    LANGUAGE plpgsql
    AS $$
	BEGIN 	
		RETURN QUERY SELECT "relations"."id", 
							...
							"relations"."userId"
					FROM "relations" 
					WHERE ("relations"."assignmentId1" = "FltAssignmentId" OR "relations"."assignmentId2" = "FltAssignmentId") 
							AND "relations"."removed" IS NULL;
	END;
	$$;


ALTER FUNCTION public."GetRelationsByAssignmentId"("FltAssignmentId" bigint) OWNER TO postgres;

--
-- TOC entry 435 (class 1255 OID 25422)
-- Name: GetRelationsByDocumentId(bigint); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."GetRelationsByDocumentId"("FltDocumentId" bigint) RETURNS TABLE(id bigint, "documentId1" bigint, "documentId2" bigint, "assignmentId1" bigint, "assignmentId2" bigint, created_at timestamp without time zone, updated_at timestamp without time zone, removed timestamp without time zone, "userId" bigint)
    LANGUAGE plpgsql
    AS $$
	BEGIN 	
		RETURN QUERY SELECT "relations"."id", 
							...
							"relations"."userId"
					FROM "relations" 
					WHERE ("relations"."documentId1" = "FltDocumentId" OR "relations"."documentId2" = "FltDocumentId") 
							AND "relations"."removed" IS NULL;
	END;
	$$;


ALTER FUNCTION public."GetRelationsByDocumentId"("FltDocumentId" bigint) OWNER TO postgres;

--
-- TOC entry 437 (class 1255 OID 25424)
-- Name: GetRelationsByDocumentIdAndAssignmentId(bigint, bigint); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."GetRelationsByDocumentIdAndAssignmentId"("FltDocumentId" bigint, "FltAssignmentId" bigint) RETURNS TABLE(id bigint, "documentId1" bigint, "documentId2" bigint, "assignmentId1" bigint, "assignmentId2" bigint, created_at timestamp without time zone, updated_at timestamp without time zone, removed timestamp without time zone, "userId" bigint)
    LANGUAGE plpgsql
    AS $$
	BEGIN 	
		RETURN QUERY SELECT "relations"."id", 
					...
					FROM "relations" 
					WHERE ("relations"."documentId1" = "FltDocumentId" OR "relations"."documentId2" = "FltDocumentId")
							AND ("relations"."assignmentId1" = "FltAssignmentId" OR "relations"."assignmentId2" = "FltAssignmentId") 
							AND "relations"."removed" IS NULL;
	END;
	$$;


ALTER FUNCTION public."GetRelationsByDocumentIdAndAssignmentId"("FltDocumentId" bigint, "FltAssignmentId" bigint) OWNER TO postgres;

--
-- TOC entry 382 (class 1255 OID 16476)
...
--
-- TOC entry 383 (class 1255 OID 16477)
...
--
-- TOC entry 384 (class 1255 OID 16478)
...
--
-- TOC entry 385 (class 1255 OID 16479)
...
--
-- TOC entry 386 (class 1255 OID 16480)
...
--
-- TOC entry 387 (class 1255 OID 16481)
...
--
-- TOC entry 388 (class 1255 OID 16482)
...
--
-- TOC entry 389 (class 1255 OID 16483)
...
--
-- TOC entry 390 (class 1255 OID 16484)
...
--
-- TOC entry 420 (class 1255 OID 25406)
-- Name: GetUsersByRoleId(smallint); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."GetUsersByRoleId"("FltRoleId" smallint) RETURNS TABLE(id bigint, login character varying, surname character varying, firstname character varying, patronymic character varying, department integer, email character varying, created_at timestamp without time zone, updated_at timestamp without time zone, roleid smallint)
    LANGUAGE plpgsql
    AS $$
	BEGIN 	
		RETURN QUERY SELECT "users"."id", 
							...
							"users"."roleid"
					FROM "users" 
					WHERE "users"."roleid" = "FltRoleId" AND "users"."removed" IS NULL;
	END;
	$$;


ALTER FUNCTION public."GetUsersByRoleId"("FltRoleId" smallint) OWNER TO postgres;

--
-- TOC entry 391 (class 1255 OID 16485)
...
--
-- TOC entry 392 (class 1255 OID 16486)
...
--
-- TOC entry 393 (class 1255 OID 16487)
...
--
-- TOC entry 394 (class 1255 OID 16488)
...
--
-- TOC entry 395 (class 1255 OID 16489)
...
--
-- TOC entry 396 (class 1255 OID 16490)
...
--
-- TOC entry 290 (class 1255 OID 16491)
...
--
-- TOC entry 397 (class 1255 OID 16492)
...
--
-- TOC entry 398 (class 1255 OID 16493)
...
--
-- TOC entry 399 (class 1255 OID 16494)
...
--
-- TOC entry 429 (class 1255 OID 25413)
...
--
-- TOC entry 400 (class 1255 OID 16496)
...
--
-- TOC entry 401 (class 1255 OID 16497)
...
--
-- TOC entry 402 (class 1255 OID 16498)
...
--
-- TOC entry 427 (class 1255 OID 25425)
-- Name: RemoveRelation(bigint); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."RemoveRelation"("FltId" bigint) RETURNS TABLE(id bigint, "documentId1" bigint, "documentId2" bigint, "assignmentId1" bigint, "assignmentId2" bigint, created_at timestamp without time zone, updated_at timestamp without time zone, removed timestamp without time zone, "userId" bigint)
    LANGUAGE plpgsql
    AS $$
BEGIN
	UPDATE "relations" 
...
ALTER FUNCTION public."RemoveRelation"("FltId" bigint) OWNER TO postgres;

--
-- TOC entry 403 (class 1255 OID 16499)
...
--
-- TOC entry 404 (class 1255 OID 16500)
...
--
-- TOC entry 405 (class 1255 OID 16501)
...
--
-- TOC entry 406 (class 1255 OID 16502)
...
--
-- TOC entry 407 (class 1255 OID 16503)
...
--
-- TOC entry 408 (class 1255 OID 16504)
...
--
-- TOC entry 439 (class 1255 OID 25427)
-- Name: UpdateAssignmentInfo(bigint, smallint, character varying, text, bigint, bigint); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."UpdateAssignmentInfo"("FltAssignmentId" bigint, "FltTypeId" smallint, "FltText" character varying, "FltDescription" text, "FltBaseId" bigint, "FltDocumentId" bigint) RETURNS TABLE(id bigint, "documentId" bigint, "typeId" smallint, "authorId" bigint, created_at timestamp without time zone, updated_at timestamp without time zone, removed timestamp without time zone, text character varying, "executorId" bigint, "baseId" bigint, viewed_at timestamp without time zone, "mainId" bigint, description text)
    LANGUAGE plpgsql
    AS $$
	BEGIN 	
	UPDATE "assignments" 
...
ALTER FUNCTION public."UpdateAssignmentInfo"("FltAssignmentId" bigint, "FltTypeId" smallint, "FltText" character varying, "FltDescription" text, "FltBaseId" bigint, "FltDocumentId" bigint) OWNER TO postgres;

--
-- TOC entry 410 (class 1255 OID 16506)
...
--
-- TOC entry 411 (class 1255 OID 16507)
...
--
-- TOC entry 423 (class 1255 OID 16508)
...
--
-- TOC entry 440 (class 1255 OID 25428)
-- Name: UpdateDocumentInfo(bigint, character varying, character varying, character varying, timestamp without time zone, timestamp without time zone, character varying, character varying, character varying, text, character varying, character varying, timestamp without time zone, character varying, character varying, character varying, bigint, character varying, character varying, timestamp without time zone, bigint, bigint); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."UpdateDocumentInfo"("FltDocumentId" bigint, "FltDescription" character varying, "FltOrderNum" character varying, "FltName" character varying, "FltCreationDate" timestamp without time zone, "FltCloseDate" timestamp without time zone, "FltCoExecutor" character varying, "FltColName" character varying, "FltSumContract" character varying, "FltPhases" text, "FltNote" character varying, "FltAuthor" character varying, "FltAcqDate" timestamp without time zone, "FltCustomer" character varying, "FltAddresser" character varying, "FltSignatory" character varying, "FltExecutor" bigint, "FltLetterExecutor" character varying, "FltOuterNum" character varying, "FltOuterDate" timestamp without time zone, "FltBaseId" bigint, "FltBaseAssignmentId" bigint) RETURNS TABLE(id bigint, description character varying, "authorId" bigint, file character varying, created_at timestamp without time zone, updated_at timestamp without time zone, "departmentId" bigint, "orderNum" character varying, "deliveryId" smallint, "recorderId" bigint, "baseId" bigint, "baseAssignmentId" bigint, "linkedDocId" bigint, "typeId" smallint, removed timestamp without time zone, name character varying, "creationDate" timestamp without time zone, "closeDate" timestamp without time zone, "coExecutor" character varying, "colName" character varying, "sumContract" character varying, phases text, note character varying, author character varying, "acqDate" timestamp without time zone, customer character varying, addresser character varying, executor bigint, signatory character varying, "letterExecutor" character varying, "outerNum" character varying, "outerDate" timestamp without time zone)
    LANGUAGE plpgsql
    AS $$
	BEGIN 	
	UPDATE "documents" 
		SET "updated_at" = current_timestamp,
			...
			"outerNum" = "FltOuterNum",
			"outerDate" = "FltOuterDate",
			"baseId" = "FltBaseId",
			"baseAssignmentId" = "FltBaseAssignmentId"
...
--
-- TOC entry 413 (class 1255 OID 16511)
...
--
-- TOC entry 414 (class 1255 OID 16512)
...
--
-- TOC entry 415 (class 1255 OID 16513)
...
--
-- TOC entry 438 (class 1255 OID 25426)
-- Name: UpdateRelation(bigint, bigint, bigint, bigint, bigint); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."UpdateRelation"("FltId" bigint, "FltDocumentId1" bigint, "FltDocumentId2" bigint, "FltAssignmentId1" bigint, "FltAssignmentId2" bigint) RETURNS TABLE(id bigint, "documentId1" bigint, "documentId2" bigint, "assignmentId1" bigint, "assignmentId2" bigint, created_at timestamp without time zone, updated_at timestamp without time zone, removed timestamp without time zone, "userId" bigint)
    LANGUAGE plpgsql
    AS $$
BEGIN
	UPDATE "relations" 
		SET "documentId1" = "FltDocumentId1",
			"documentId2" = "FltDocumentId2",
			"assignmentId1" = "FltAssignmentId1",
			"assignmentId2" = "FltAssignmentId2",
			"updated_at" = current_timestamp,
			"removed" = current_timestamp
		WHERE "relations"."id" = "FltId";
	RETURN QUERY SELECT "id",
...
ALTER FUNCTION public."UpdateRelation"("FltId" bigint, "FltDocumentId1" bigint, "FltDocumentId2" bigint, "FltAssignmentId1" bigint, "FltAssignmentId2" bigint) OWNER TO postgres;

--
-- TOC entry 416 (class 1255 OID 16514)
...
--
-- TOC entry 417 (class 1255 OID 16515)
...
--
-- TOC entry 418 (class 1255 OID 16516)
...
--
-- TOC entry 419 (class 1255 OID 16517)
...
CREATE TABLE public.documents (
    ...
    "outerNum" character varying(32),
    "outerDate" timestamp without time zone
);
...
--
-- TOC entry 249 (class 1259 OID 16633)
...
--
-- TOC entry 250 (class 1259 OID 16637)
...
--
-- TOC entry 253 (class 1259 OID 16643)
...
--
-- TOC entry 254 (class 1259 OID 16644)
...
--
-- TOC entry 258 (class 1259 OID 16658)
...
--
-- TOC entry 259 (class 1259 OID 16663)
...
--
-- TOC entry 260 (class 1259 OID 16666)
...
--
-- TOC entry 261 (class 1259 OID 16667)
...
--
-- TOC entry 262 (class 1259 OID 16668)
...
--
-- TOC entry 263 (class 1259 OID 16672)
...
--
-- TOC entry 264 (class 1259 OID 16673)
...
--
-- TOC entry 266 (class 1259 OID 16677)
...
--
-- TOC entry 267 (class 1259 OID 16680)
...
--
-- TOC entry 287 (class 1259 OID 25429)
...
CREATE TABLE public.relations (
    ...
    "documentId1" bigint,
    "documentId2" bigint,
    "assignmentId1" bigint,
    "assignmentId2" bigint,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_at timestamp without time zone,
    removed timestamp without time zone,
    "userId" bigint NOT NULL
...
--
-- TOC entry 288 (class 1259 OID 25433)
...
--
-- TOC entry 270 (class 1259 OID 16690)
...
--
-- TOC entry 274 (class 1259 OID 16700)
...
--
-- TOC entry 279 (class 1259 OID 16713)
...
--
-- TOC entry 280 (class 1259 OID 16717)
...
--
-- TOC entry 281 (class 1259 OID 16718)
...
--
-- TOC entry 282 (class 1259 OID 16719)
...
--
-- TOC entry 283 (class 1259 OID 16726)
...
--
-- TOC entry 284 (class 1259 OID 16729)
...
--
-- TOC entry 286 (class 1259 OID 16734)
...
--
-- TOC entry 3516 (class 2604 OID 16735)
...
--
-- TOC entry 3517 (class 2604 OID 16736)
...
--
-- TOC entry 3519 (class 2604 OID 16737)
...
--
-- TOC entry 3520 (class 2604 OID 16738)
...
--
-- TOC entry 3523 (class 2604 OID 16739)
...
--
-- TOC entry 3525 (class 2604 OID 16740)
...
--
-- TOC entry 3527 (class 2604 OID 16741)
...
--
-- TOC entry 3529 (class 2604 OID 16742)
...
--
-- TOC entry 3531 (class 2604 OID 16743)
...
--
-- TOC entry 3533 (class 2604 OID 16744)
...
--
-- TOC entry 3534 (class 2604 OID 16745)
...
--
-- TOC entry 3537 (class 2604 OID 16746)
...
--
-- TOC entry 3539 (class 2604 OID 16747)
...
--
-- TOC entry 3541 (class 2604 OID 16748)
...
--
-- TOC entry 3542 (class 2604 OID 16749)
...
--
-- TOC entry 3543 (class 2604 OID 16750)
...
--
-- TOC entry 3545 (class 2604 OID 16751)
...
--
-- TOC entry 3547 (class 2604 OID 16752)
...
--
-- TOC entry 3549 (class 2604 OID 16753)
...
--
-- TOC entry 3551 (class 2604 OID 16754)
...
--
-- TOC entry 3553 (class 2604 OID 16755)
...
--
-- TOC entry 3555 (class 2604 OID 16756)
...
--
-- TOC entry 3557 (class 2604 OID 16757)
...
--
-- TOC entry 3558 (class 2604 OID 16758)
...
--
-- TOC entry 3559 (class 2604 OID 16760)
...
--
-- TOC entry 3561 (class 2604 OID 16761)
...
--
-- TOC entry 3562 (class 2604 OID 16762)
...
--
-- TOC entry 3579 (class 2604 OID 25434)
...
--
-- TOC entry 3563 (class 2604 OID 16763)
...
--
-- TOC entry 3565 (class 2604 OID 16764)
...
--
-- TOC entry 3567 (class 2604 OID 16765)
...
--
-- TOC entry 3571 (class 2604 OID 16766)
...
--
-- TOC entry 3572 (class 2604 OID 16767)
...
--
-- TOC entry 3576 (class 2604 OID 16768)
...
--
-- TOC entry 3577 (class 2604 OID 16769)
...
--
-- TOC entry 3582 (class 2606 OID 16771)
...
--
-- TOC entry 3584 (class 2606 OID 16773)
...
--
-- TOC entry 3586 (class 2606 OID 16777)
...
--
-- TOC entry 3590 (class 2606 OID 16779)
...
--
-- TOC entry 3598 (class 2606 OID 16781)
...
--
-- TOC entry 3594 (class 2606 OID 16785)
...
--
-- TOC entry 3592 (class 2606 OID 16787)
...
--
-- TOC entry 3600 (class 2606 OID 16789)
...
--
-- TOC entry 3602 (class 2606 OID 16791)
...
--
-- TOC entry 3604 (class 2606 OID 16793)
...
--
-- TOC entry 3606 (class 2606 OID 16795)
...
--
-- TOC entry 3608 (class 2606 OID 16797)
...
--
-- TOC entry 3610 (class 2606 OID 16799)
...
--
-- TOC entry 3612 (class 2606 OID 16801)
...
--
-- TOC entry 3614 (class 2606 OID 16805)
...
--
-- TOC entry 3618 (class 2606 OID 16807)
...
--
-- TOC entry 3622 (class 2606 OID 16809)
...
--
-- TOC entry 3624 (class 2606 OID 16811)
...
--
-- TOC entry 3620 (class 2606 OID 16813)
...
--
-- TOC entry 3626 (class 2606 OID 16815)
...
--
-- TOC entry 3628 (class 2606 OID 16817)
...
--
-- TOC entry 3630 (class 2606 OID 16819)
...
--
-- TOC entry 3632 (class 2606 OID 16821)
...
--
-- TOC entry 3636 (class 2606 OID 16823)
...
--
-- TOC entry 3634 (class 2606 OID 16825)
...
--
-- TOC entry 3638 (class 2606 OID 16827)
...
--
-- TOC entry 3640 (class 2606 OID 16829)
...
--
-- TOC entry 3642 (class 2606 OID 16831)
...
--
-- TOC entry 3669 (class 2606 OID 25436)
...
--
-- TOC entry 3645 (class 2606 OID 16833)
...
--
-- TOC entry 3647 (class 2606 OID 16835)
...
--
-- TOC entry 3649 (class 2606 OID 16837)
...
--
-- TOC entry 3651 (class 2606 OID 16839)
...
--
-- TOC entry 3653 (class 2606 OID 16841)
...
--
-- TOC entry 3655 (class 2606 OID 16843)
...
--
-- TOC entry 3657 (class 2606 OID 16845)
...
--
-- TOC entry 3667 (class 2606 OID 16849)
...
--
-- TOC entry 3659 (class 2606 OID 16851)
...
--
-- TOC entry 3661 (class 2606 OID 16853)
...
--
-- TOC entry 3663 (class 2606 OID 16855)
...
--
-- TOC entry 3643 (class 1259 OID 16856)
...
--
-- TOC entry 3677 (class 2606 OID 16857)
...
--
-- TOC entry 3670 (class 2606 OID 16862)
...
--
-- TOC entry 3671 (class 2606 OID 16867)
...
--
-- TOC entry 3673 (class 2606 OID 16877)
...
--
-- TOC entry 3674 (class 2606 OID 16882)
...
--
-- TOC entry 3675 (class 2606 OID 16887)
...
--
-- TOC entry 3678 (class 2606 OID 16897)
...
--
-- TOC entry 3679 (class 2606 OID 16902)
...
--
-- TOC entry 3692 (class 2606 OID 16907)
...
--
-- TOC entry 3687 (class 2606 OID 16912)
...
--
-- TOC entry 3688 (class 2606 OID 16917)
...
--
-- TOC entry 3689 (class 2606 OID 16922)
...
--
-- TOC entry 3690 (class 2606 OID 16927)
...
--
-- TOC entry 3685 (class 2606 OID 16932)
...
--
-- TOC entry 3686 (class 2606 OID 16937)
...
--
-- TOC entry 3680 (class 2606 OID 16942)
-- Name: assignments fk_assignments_documentId_documents_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.assignments
    ADD CONSTRAINT "fk_assignments_documentId_documents_id" FOREIGN KEY ("documentId") REFERENCES public.documents(id);


--
-- TOC entry 3681 (class 2606 OID 16947)
-- Name: assignments fk_assignments_typeId_assignments_types_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.assignments
    ADD CONSTRAINT "fk_assignments_typeId_assignments_types_id" FOREIGN KEY ("typeId") REFERENCES public.assignment_types(id);


--
-- TOC entry 3682 (class 2606 OID 16952)
-- Name: assignments fk_authorId_assignments_users_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.assignments
    ADD CONSTRAINT "fk_authorId_assignments_users_id" FOREIGN KEY ("authorId") REFERENCES public.users(id);


--
-- TOC entry 3683 (class 2606 OID 16957)
-- Name: assignments fk_basId_assignments_assignments_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.assignments
    ADD CONSTRAINT "fk_basId_assignments_assignments_id" FOREIGN KEY ("baseId") REFERENCES public.assignments(id) NOT VALID;


--
-- TOC entry 3691 (class 2606 OID 16962)
...
--
-- TOC entry 3697 (class 2606 OID 16972)
...
--
-- TOC entry 3698 (class 2606 OID 16977)
...
--
-- TOC entry 3699 (class 2606 OID 16982)
...
--
-- TOC entry 3700 (class 2606 OID 16987)
...
--
-- TOC entry 3701 (class 2606 OID 16992)
...
--
-- TOC entry 3702 (class 2606 OID 16997)
...
--
-- TOC entry 3703 (class 2606 OID 17002)
...
--
-- TOC entry 3693 (class 2606 OID 17007)
...
--
-- TOC entry 3711 (class 2606 OID 17012)
...
--
-- TOC entry 3712 (class 2606 OID 17017)
...
--
-- TOC entry 3713 (class 2606 OID 17022)
...
--
-- TOC entry 3714 (class 2606 OID 17027)
...
--
-- TOC entry 3704 (class 2606 OID 17032)
-- Name: documents fk_documents_authorId_users_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.documents
    ADD CONSTRAINT "fk_documents_authorId_users_id" FOREIGN KEY ("authorId") REFERENCES public.users(id) NOT VALID;


--
-- TOC entry 3705 (class 2606 OID 17037)
-- Name: documents fk_documents_baseAssignmentId_assignments_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.documents
    ADD CONSTRAINT "fk_documents_baseAssignmentId_assignments_id" FOREIGN KEY ("baseAssignmentId") REFERENCES public.assignments(id) NOT VALID;


--
-- TOC entry 3706 (class 2606 OID 17042)
-- Name: documents fk_documents_baseId_documents_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.documents
    ADD CONSTRAINT "fk_documents_baseId_documents_id" FOREIGN KEY ("baseId") REFERENCES public.documents(id) NOT VALID;


--
-- TOC entry 3707 (class 2606 OID 17047)
-- Name: documents fk_documents_deliveryId_delivery_types_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.documents
    ADD CONSTRAINT "fk_documents_deliveryId_delivery_types_id" FOREIGN KEY ("deliveryId") REFERENCES public.delivery_types(id) NOT VALID;


--
-- TOC entry 3708 (class 2606 OID 17052)
-- Name: documents fk_documents_linkedDocId_documents_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.documents
    ADD CONSTRAINT "fk_documents_linkedDocId_documents_id" FOREIGN KEY ("linkedDocId") REFERENCES public.documents(id) NOT VALID;


--
-- TOC entry 3709 (class 2606 OID 17057)
-- Name: documents fk_documents_recorderId_users_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.documents
    ADD CONSTRAINT "fk_documents_recorderId_users_id" FOREIGN KEY ("recorderId") REFERENCES public.users(id) NOT VALID;


--
-- TOC entry 3710 (class 2606 OID 17062)
-- Name: documents fk_documents_typeId_document_types_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.documents
    ADD CONSTRAINT "fk_documents_typeId_document_types_id" FOREIGN KEY ("typeId") REFERENCES public.document_types(id) NOT VALID;


--
-- TOC entry 3684 (class 2606 OID 17067)
...
--
-- TOC entry 3715 (class 2606 OID 17072)
...
--
-- TOC entry 3716 (class 2606 OID 17077)
...
--
-- TOC entry 3717 (class 2606 OID 17082)
...
--
-- TOC entry 3718 (class 2606 OID 17087)
...
--
-- TOC entry 3719 (class 2606 OID 17092)
...
--
-- TOC entry 3720 (class 2606 OID 17097)
...
--
-- TOC entry 3721 (class 2606 OID 17102)
...
--
-- TOC entry 3722 (class 2606 OID 17107)
...
--
-- TOC entry 3723 (class 2606 OID 17112)
...
--
-- TOC entry 3694 (class 2606 OID 17117)
...
--
-- TOC entry 3724 (class 2606 OID 17122)
...
--
-- TOC entry 3725 (class 2606 OID 17127)
...
--
-- TOC entry 3738 (class 2606 OID 25437)
-- Name: relations fk_relations_assignmentId1_assignments_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.relations
    ADD CONSTRAINT "fk_relations_assignmentId1_assignments_id" FOREIGN KEY ("assignmentId1") REFERENCES public.assignments(id) NOT VALID;


--
-- TOC entry 3739 (class 2606 OID 25442)
-- Name: relations fk_relations_assignmentId2_assignments_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.relations
    ADD CONSTRAINT "fk_relations_assignmentId2_assignments_id" FOREIGN KEY ("assignmentId2") REFERENCES public.assignments(id) NOT VALID;


--
-- TOC entry 3740 (class 2606 OID 25447)
-- Name: relations fk_relations_documentId1_documents_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.relations
    ADD CONSTRAINT "fk_relations_documentId1_documents_id" FOREIGN KEY ("documentId1") REFERENCES public.documents(id) NOT VALID;


--
-- TOC entry 3741 (class 2606 OID 25452)
-- Name: relations fk_relations_documentId2_documents_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.relations
    ADD CONSTRAINT "fk_relations_documentId2_documents_id" FOREIGN KEY ("documentId2") REFERENCES public.documents(id) NOT VALID;


--
-- TOC entry 3742 (class 2606 OID 25457)
-- Name: relations fk_relations_userId_users_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.relations
    ADD CONSTRAINT "fk_relations_userId_users_id" FOREIGN KEY ("userId") REFERENCES public.users(id) NOT VALID;


--
-- TOC entry 3726 (class 2606 OID 17132)
...
--
-- TOC entry 3727 (class 2606 OID 17137)
...
--
-- TOC entry 3728 (class 2606 OID 17142)
...
--
-- TOC entry 3729 (class 2606 OID 17147)
...
--
-- TOC entry 3730 (class 2606 OID 17152)
...
--
-- TOC entry 3731 (class 2606 OID 17157)
...
--
-- TOC entry 3732 (class 2606 OID 17162)
...
--
-- TOC entry 3695 (class 2606 OID 17167)
...
--
-- TOC entry 3736 (class 2606 OID 17182)
...
--
-- TOC entry 3737 (class 2606 OID 17187)
...
--
-- TOC entry 3733 (class 2606 OID 17192)
...
--
-- TOC entry 3466 (class 0 OID 118067)
-- Dependencies: 198
-- Data for Name: User; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public."User" VALUES (2, 2, 5, NULL, '2021-06-26 17:56:40.246298', NULL, NULL);


--
-- TOC entry 3464 (class 0 OID 118062)
-- Dependencies: 196
...
--
-- TOC entry 3467 (class 0 OID 118073)
-- Dependencies: 199
...
--
-- TOC entry 3468 (class 0 OID 118079)
-- Dependencies: 200
...
--
-- TOC entry 3469 (class 0 OID 118083)
-- Dependencies: 201
...
--
-- TOC entry 3472 (class 0 OID 118093)
-- Dependencies: 204
...
--
-- TOC entry 3474 (class 0 OID 118099)
-- Dependencies: 206
-- Data for Name: assignment_types; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.assignment_types VALUES (1, 'Срочное', '2021-10-15 14:51:33.489593', NULL, NULL);
INSERT INTO public.assignment_types VALUES (2, 'Важное', '2021-10-15 14:51:33.489593', NULL, NULL);
INSERT INTO public.assignment_types VALUES (3, 'Обычное', '2021-11-29 12:37:23.589145', NULL, NULL);
INSERT INTO public.assignment_types VALUES (4, 'Не срочное', '2021-11-29 12:37:23.589145', NULL, NULL);


--
-- TOC entry 3475 (class 0 OID 118103)
-- Dependencies: 207
...
--
-- TOC entry 3476 (class 0 OID 118110)
-- Dependencies: 208
...
--
-- TOC entry 3478 (class 0 OID 118119)
-- Dependencies: 210
...
--
-- TOC entry 3482 (class 0 OID 118129)
-- Dependencies: 214
...
--
-- TOC entry 3484 (class 0 OID 118138)
-- Dependencies: 216
...
--
-- TOC entry 3486 (class 0 OID 118147)
-- Dependencies: 218
...
--
-- TOC entry 3488 (class 0 OID 118152)
-- Dependencies: 220
...
--
-- TOC entry 3490 (class 0 OID 118158)
-- Dependencies: 222
...
--
-- TOC entry 3491 (class 0 OID 118162)
-- Dependencies: 223
-- Data for Name: delivery_types; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.delivery_types VALUES (1, 'Почта', '2021-06-16 10:52:25.112092', NULL, NULL);
INSERT INTO public.delivery_types VALUES (2, 'Электронная почта', '2021-06-16 10:52:25.112092', NULL, NULL);
INSERT INTO public.delivery_types VALUES (3, 'Курьер', '2021-06-16 10:52:25.112092', NULL, NULL);


--
-- TOC entry 3493 (class 0 OID 118168)
-- Dependencies: 225
...
--
-- TOC entry 3495 (class 0 OID 118174)
-- Dependencies: 227
...
--
-- TOC entry 3496 (class 0 OID 118177)
-- Dependencies: 228
...
--
-- TOC entry 3499 (class 0 OID 118184)
-- Dependencies: 231
-- Data for Name: document_types; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.document_types VALUES (1, 'Служебная записка', '2021-06-15 17:57:13.818256', NULL, NULL);
INSERT INTO public.document_types VALUES (2, 'Договор', '2021-06-16 13:28:42.794684', NULL, NULL);
INSERT INTO public.document_types VALUES (4, 'Прочее', '2021-09-27 18:51:30.255934', NULL, NULL);
INSERT INTO public.document_types VALUES (6, 'Входящее письмо', '2021-10-18 18:18:57.743618', NULL, NULL);
INSERT INTO public.document_types VALUES (12, 'Уведомление', '2022-06-09 09:23:08.779796', NULL, NULL);
INSERT INTO public.document_types VALUES (9, 'Приказ по организационной деятельности', '2022-06-09 09:23:08.779796', NULL, NULL);
INSERT INTO public.document_types VALUES (7, 'Исходящее письмо', '2021-12-21 13:21:03.162982', NULL, NULL);
INSERT INTO public.document_types VALUES (13, 'Организационно-распорядительный документ', '2022-06-10 09:46:26.061102', NULL, NULL);
INSERT INTO public.document_types VALUES (3, 'Докладная записка', '2021-06-16 13:28:42.794684', NULL, '2022-07-01 15:28:42.794684');
INSERT INTO public.document_types VALUES (8, 'Входящее внутреннее письмо', '2022-06-09 09:23:08.779796', NULL, '2022-07-01 15:28:42.794684');
INSERT INTO public.document_types VALUES (10, 'Приказ об утверждении штатного расписания', '2022-06-09 09:23:08.779796', NULL, '2022-07-01 15:28:42.794684');
INSERT INTO public.document_types VALUES (11, 'Доверенность', '2022-06-09 09:23:08.779796', NULL, '2022-07-01 15:28:42.794684');
INSERT INTO public.document_types VALUES (14, 'Дополнительное соглашение', '2024-07-03 08:50:42.037193', NULL, NULL);
INSERT INTO public.document_types VALUES (15, 'Соглашение о неразглашении конфиденциальной информации', '2024-07-03 08:51:06.107341', NULL, NULL);


--
-- TOC entry 3501 (class 0 OID 118190)
-- Dependencies: 233
...
--
-- TOC entry 3502 (class 0 OID 118197)
-- Dependencies: 234
...
--
-- TOC entry 3504 (class 0 OID 118203)
-- Dependencies: 236
...
--
-- TOC entry 3507 (class 0 OID 118211)
-- Dependencies: 239
...
--
-- TOC entry 3509 (class 0 OID 118217)
-- Dependencies: 241
...
--
-- TOC entry 3511 (class 0 OID 118226)
-- Dependencies: 243
...
--
-- TOC entry 3513 (class 0 OID 118235)
-- Dependencies: 245
...
--
-- TOC entry 3514 (class 0 OID 118241)
-- Dependencies: 246
...
--
-- TOC entry 3517 (class 0 OID 118248)
-- Dependencies: 249
-- Data for Name: mailsettings; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.mailsettings VALUES (4, 'Согласование документа', '2022-06-23 12:59:45.660629', NULL, NULL);
INSERT INTO public.mailsettings VALUES (5, 'Исполнение поручения', '2022-06-23 13:00:28.901246', NULL, NULL);
INSERT INTO public.mailsettings VALUES (6, 'Перенос срока исполнения поручения', '2022-06-23 13:00:55.786691', NULL, NULL);
INSERT INTO public.mailsettings VALUES (7, 'Ознакомление с документом', '2022-09-15 14:55:37.394006', NULL, NULL);
INSERT INTO public.mailsettings VALUES (8, 'Назначение на личный контроль', '2022-09-15 14:55:37.394006', NULL, NULL);
INSERT INTO public.mailsettings VALUES (9, 'Отказ в согласовании документа', '2023-02-16 13:54:29.017878', NULL, NULL);
INSERT INTO public.mailsettings VALUES (10, 'Оповещение о ходе согласования', '2023-03-22 16:29:53.215162', NULL, NULL);


--
-- TOC entry 3519 (class 0 OID 118254)
-- Dependencies: 251
...
--
-- TOC entry 3521 (class 0 OID 118259)
-- Dependencies: 253
...
--
-- TOC entry 3523 (class 0 OID 118264)
-- Dependencies: 255
...
--
-- TOC entry 3524 (class 0 OID 118270)
-- Dependencies: 256
...
--
-- TOC entry 3526 (class 0 OID 118276)
-- Dependencies: 258
...
--
-- TOC entry 3528 (class 0 OID 118282)
-- Dependencies: 260
...
--
-- TOC entry 3530 (class 0 OID 118288)
-- Dependencies: 262
-- Data for Name: roles; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.roles VALUES (1, 'Администратор', 'ADMIN', '2021-06-03 14:29:20.298417', NULL, NULL);
INSERT INTO public.roles VALUES (2, 'Пользователь с ограничениями', 'USER', '2021-06-03 14:29:20.298417', NULL, NULL);
INSERT INTO public.roles VALUES (3, 'Пользователь полн.', 'USER_FULL', '2025-11-01 14:35:18.732654', NULL, NULL);
INSERT INTO public.roles VALUES (4, 'Руководитель', 'LEADER', '2025-11-01 16:18:23.691219', NULL, NULL);



--
-- TOC entry 3531 (class 0 OID 118292)
-- Dependencies: 263
-- Data for Name: statuses; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.statuses VALUES (1, 'На согласовании', '2022-03-30 10:43:16.292594', NULL, NULL, 'approving', 1);
INSERT INTO public.statuses VALUES (2, 'Не согласован', '2022-03-30 10:43:16.292594', NULL, NULL, 'refused', 1);
INSERT INTO public.statuses VALUES (3, 'Согласован', '2022-03-30 10:43:16.292594', NULL, NULL, 'approved', 1);
INSERT INTO public.statuses VALUES (4, 'В архиве', '2022-03-30 10:43:16.292594', NULL, NULL, 'in_archive', 1);
INSERT INTO public.statuses VALUES (5, 'Удалён', '2022-03-30 10:43:16.292594', NULL, NULL, 'deleted', 1);
INSERT INTO public.statuses VALUES (6, 'На рассмотрении', '2022-03-30 10:52:36.380997', NULL, NULL, 'considering', 2);
INSERT INTO public.statuses VALUES (8, 'Отклонено', '2022-03-30 10:52:36.380997', NULL, NULL, 'rejected', 2);
INSERT INTO public.statuses VALUES (9, 'Исполнено', '2022-03-30 10:52:36.380997', NULL, NULL, 'done', 2);
INSERT INTO public.statuses VALUES (10, 'Отклонено автором', '2022-03-30 10:52:36.380997', NULL, NULL, 'rejected_by_author', 2);
INSERT INTO public.statuses VALUES (7, 'На исполнении', '2022-03-30 10:52:36.380997', NULL, NULL, 'execution', 2);
INSERT INTO public.statuses VALUES (11, 'Отменено автором', '2022-04-07 16:22:11.965341', NULL, NULL, 'refused_by_author', 1);


--
-- TOC entry 3532 (class 0 OID 118296)
-- Dependencies: 264
-- Data for Name: text_timezone; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.text_timezone VALUES (2, '2022-01-12 17:14:34.265395');


--
-- TOC entry 3534 (class 0 OID 118301)
-- Dependencies: 266
...
--
-- TOC entry 3537 (class 0 OID 118309)
-- Dependencies: 269
...
--
-- TOC entry 3538 (class 0 OID 118317)
-- Dependencies: 270
...
--
-- TOC entry 3540 (class 0 OID 118322)
-- Dependencies: 272
...
-- Completed on 2025-05-30 15:06:50
